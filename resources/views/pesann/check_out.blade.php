...
<div class="row bg-warning">
    ...
    <div class="col-md-12">
        <div class="card bg-warning">
            <div class="card-body">
                <h3><i class="fa fa-shopping-cart text-lg"></i> Check Out</h3>
                @if(!empty($pesanan))
                ...
                <table class="table table-dark table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            <td>{{ $no++ }}</td>
                            <td>
                                <img src="{{ url('images') }}/{{ $pesanan_detail->barang->gambar }}" width="150"
                                    alt="...">
                            </td>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="5"><strong>Total Harga :</strong></th>
                            <th colspan=""><strong>Rp.
                                    {{ number_format($pesanan->jumlah_harga) }}</strong></th>
                            <th>
